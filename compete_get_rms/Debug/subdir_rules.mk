...
build-662382783: ../empty.syscfg
	@echo 'Building file: "$<"'
	@echo 'Invoking: SysConfig'
	"C:/TI/ccstheia141/ccs/utils/sysconfig_1.20.0/sysconfig_cli.bat" --script "C:/Users/34808/workspace_ccstheia/compete_get_rms/empty.syscfg" -o "." -s "C:/TI/mspm0_sdk_2_01_00_03/.metadata/product.json" --compiler ticlang
	@echo 'Finished building: "$<"'
	@echo ' '

device_linker.cmd: build-662382783 ../empty.syscfg
device.opt: build-662382783
device.cmd.genlibs: build-662382783
ti_msp_dl_config.c: build-662382783
ti_msp_dl_config.h: build-662382783
Event.dot: build-662382783
